    ...
    async def async_step_user(self,
        ...
        if user_input is not None:
            ...
            try:
                ...
                auth = None
                if user_input.get(CONF_USERNAME) and user_input.get(
                        CONF_PASSWORD):
                    auth = (user_input[CONF_USERNAME],
                ...
                if response.status_code == 200:
                    try:
                        ...
                        sunshine_version = config_data.get(
                            "version", "Unknown")
                    except:
                        pass
                ...
                if not errors:
                    ...
                    return self.async_create_entry(title=server_name,
                                                   data=user_input)
